...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.posts.index')->with('success', 'Статья добавлена');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('user.posts.index')->with('success', 'Изменения сохранены');
    }
    ...
    public function destroy($id)
    {
        ...
        $post->delete();
        return redirect()->route('user.posts.index')->with('success', 'Статья удалена');
    }
}
