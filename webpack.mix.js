...
mix.copyDirectory('resources/assets/no_image', 'public/assets/no_image');

mix.copyDirectory('resources/assets/admin/img', 'public/assets/admin/img');
mix.copyDirectory('resources/assets/admin/plugins/fontawesome-free/webfonts', 'public/assets/admin/webfonts');

mix.copyDirectory('resources/assets/admin/ckeditor5', 'public/assets/admin/ckeditor5');
mix.copyDirectory('resources/assets/admin/ckfinder', 'public/assets/admin/ckfinder');
